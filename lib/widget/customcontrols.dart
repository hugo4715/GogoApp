...
class GogoControls extends StatefulWidget {
  const GogoControls({
  ...
  State<StatefulWidget> createState() {
    return _GogoControlsState();
  }
}

class _GogoControlsState extends State<GogoControls> with SingleTickerProviderStateMixin {
  ...
  Widget _buildHitArea() {
    ...
    return GestureDetector(
      ...
      child: !controller.value.isInitialized ? const Icon(Icons.hourglass_bottom) : CenterPlayButton(
